...
// import { StudentService } from '../studen.service'; // Import StudentService
// import { PackageService } from '../package.service'; // Import PackageService
...
//   imports: [CommonModule, FormsModule] // Include both CommonModule and FormsModule
// })
// export class BookingComponent implements OnInit {

//   packages: any[] = []; // Store package data
//   students: any[] = []; // Store student data
//   selectedPackageId: number | undefined; // Store the selected package ID
//   selectedStudentId: number | undefined; // Store the selected student ID
